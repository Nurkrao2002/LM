...
CREATE TYPE leave_status AS ENUM ('pending', 'admin_pending', 'manager_approved', 'manager_rejected', 'admin_approved', 'admin_rejected', 'cancelled');
...
('max_annual_leave_days', '25', 'Maximum annual leave days per year', 'leave_policy'),
('max_sick_leave_days', '12', 'Maximum sick leave days per year', 'leave_policy'),
('max_personal_leave_days', '5', 'Maximum personal leave days per year', 'leave_policy'),
('notice_period_days', '7', 'Notice period required for leave requests', 'leave_policy'),
